...
void app_main(void)
{
        ...
        esp_littlefs_flash_create_conf_t conf = ESP_LITTLEFS_FLASH_CREATE_CONFIG_DEFAULT();
        ...
        esp_err_t ret = esp_littlefs_flash_create(&handle, &conf);
        ...
        esp_littlefs_flash_delete(&handle);
